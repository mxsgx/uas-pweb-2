                ...
                <div class="table-responsive">
                    <table class="table table-vcenter table-mobile-md card-table">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="<?= base_url("/admin/program_studi/edit/{$model->id}") ?>" class="btn">
                                                    Ubah
                                                </a>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                                        <a class="dropdown-item" href="<?= base_url("/admin/program_studi/delete/{$model->id}") ?>">
                                                            Hapus
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <?php } else { ?>
                                <tr>
                                    <td colspan="2" class="text-center">Program studi kosong</td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
...
<div class="modal modal-blur fade" id="create-modal" tabindex="-1" role="dialog" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="<?= base_url('/admin/program_studi/create') ?>" method="post" class="modal-content">
