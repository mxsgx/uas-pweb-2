                        ...
                        <div class="row row-cards mb-3">
                            <div class="col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kode" name="kode" placeholder="DT170" value="<?= $rps->kode ?>">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="sks">SKS</label>
                                    <input type="number" class="form-control" id="sks" name="sks" placeholder="2" value="<?= $rps->sks ?>">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <select type="text" name="program_studi_id" id="program_studi_id" class="form-select">
                                <?php foreach ($program_studi as $model) { ?>
                                    <option value="<?= $model->id ?>" <?= $model->id == $rps->program_studi()->id ? 'selected' : '' ?>><?= $model->nama ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select type="text" name="mata_kuliah_id" id="mata_kuliah_id" class="form-select">
                                <?php foreach ($mata_kuliah as $model) { ?>
                                    <option value="<?= $model->id ?>" <?= $model->id == $rps->mata_kuliah()->id ? 'selected' : '' ?>><?= $model->nama ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-3">
